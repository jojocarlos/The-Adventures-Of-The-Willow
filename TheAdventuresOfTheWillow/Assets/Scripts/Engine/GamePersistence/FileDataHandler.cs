...
public class FileDataHandler
{
    ...
    {
        //base case - if the profileId is null, return right sway
        if (profileId == null)
        {
            return;
        }
    ...
    public void Delete(string profileId)
    {
        ...
        try
        {
            //ensure the data file exists at this path before delete the directory
            if (File.Exists(fullPath))
            {
    ...
    public Dictionary<string, GameData> LoadAllProfiles()
    {
        ...
        foreach(DirectoryInfo dirInfo in dirInfos)
        {
            ...
            //because if it is then something went wrong and be should let ourselves know
            if(profileData != null)
            {
    ...
    public string GetMostRecentlyUpdatedProfileId()
    {
        ...
        foreach(KeyValuePair<string, GameData> pair in profilesGameData)
        {
            ...
            else
            {
                ...
                //the greatest DateTiime value is the most recent
